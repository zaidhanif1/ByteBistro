...
class HFInferenceTextToImageTask extends HFInferenceTask {
    async getResponse(response, url, headers, outputType) {
        if (!response) {
            throw new InferenceOutputError_js_1.InferenceOutputError("response is undefined");
        }
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected a Blob ");
    }
}
...
class HFInferenceAudioToAudioTask extends HFInferenceTask {
    async getResponse(response) {
        if (!Array.isArray(response)) {
            throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array");
        }
        if (!response.every((elem) => {
            ...
            throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<{label: string, audio: Blob}>");
        }
        return response;
    }
}
...
class HFInferenceDocumentQuestionAnsweringTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<{answer: string, end: number, score: number, start: number}>");
    }
}
...
class HFInferenceFeatureExtractionTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<number[][][] | number[][] | number[] | number>");
    }
}
...
class HFInferenceImageClassificationTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<{label: string, score: number}>");
    }
}
...
class HFInferenceImageSegmentationTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<{label: string, mask: string, score: number}>");
    }
}
...
class HFInferenceImageToTextTask extends HFInferenceTask {
    async getResponse(response) {
        if (typeof response?.generated_text !== "string") {
            throw new InferenceOutputError_js_1.InferenceOutputError("Expected {generated_text: string}");
        }
        return response;
    }
}
...
class HFInferenceImageToImageTask extends HFInferenceTask {
    ...
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Blob");
    }
}
...
class HFInferenceObjectDetectionTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<{label: string, score: number, box: {xmin: number, ymin: number, xmax: number, ymax: number}}>");
    }
}
...
class HFInferenceFillMaskTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<{score: number, sequence: string, token: number, token_str: string}>");
    }
}
...
class HFInferenceZeroShotClassificationTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<{labels: string[], scores: number[], sequence: string}>");
    }
}
...
class HFInferenceSentenceSimilarityTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<number>");
    }
}
...
class HFInferenceTableQuestionAnsweringTask extends HFInferenceTask {
    ...
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected {aggregator: string, answer: string, cells: string[], coordinates: number[][]}");
    }
}
...
class HFInferenceTokenClassificationTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<{end: number, entity_group: string, score: number, start: number, word: string}>");
    }
}
...
class HFInferenceTranslationTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<{translation_text: string}>");
    }
}
...
class HFInferenceSummarizationTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<{summary_text: string}>");
    }
}
...
class HFInferenceVisualQuestionAnsweringTask extends HFInferenceTask {
    async getResponse(response) {
        ...
        throw new InferenceOutputError_js_1.InferenceOutputError("Expected Array<{answer: string, score: number}>");
    }
}
